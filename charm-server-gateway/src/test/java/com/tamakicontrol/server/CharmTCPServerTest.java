...
public class CharmTCPServerTest {
    ...
    CharmTCPServer server = new CharmTCPServer(502) {
        @Override
    ...
    // enable this with an @Test annotation if you want to run it
    ...
    public void socketConnected(Socket clientSocket) throws IOException {
